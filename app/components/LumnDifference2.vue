<template>
  <section
    class="bg-[#141217] border-b border-t border-[#28232f] flex flex-col gap-14 px-4 sm:px-8 lg:px-12 py-12 sm:py-32 w-full"
  >
    <div class="mx-auto w-full max-w-7xl">
      ...
      <div class="flex flex-col gap-4 items-center text-center">
        ...
        <h2
          class="font-['Cormorant_Garamond'] text-[#f4f3f5] text-[32px] sm:text-[40px] lg:text-5xl !pb-10 sm:pb-2 tracking-[1.08px]"
        >
          The LUMN Difference
        </h2>
      </div>
